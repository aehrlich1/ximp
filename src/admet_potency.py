...
class AdmetPotency:
    ...
    def _initialize_model(self, latent_dim=128, projector_dim=64, repr_himp_hidden_dim=9, rep_himp_num_layers= 2, rep_himp_dropout=0.5, rep_himp_inter=True, repr_type ='HIMP'):
    ...
    def cross_validate(self):
        ...
        self.performance_tracker.reset()
        self._initialize_model(combinations[best_combination][2], combinations[best_combination][3], combinations[best_combination][4],
                               combinations[best_combination][5], combinations[best_combination][6], combinations[best_combination][7], repr_type=self.params['repr_type'])

...
if __name__ == "__main__":
    ...
    parser.add_argument("--encoding_dim", help="Encoding dimension of features", default=8, type=int)
    ...
    parser.add_argument("--proj_hidden_dim", help="Projection hidden dimension", default=64, type=int)
    parser.add_argument("--out_dim", help="Output dimension", default=1, type=int)

    # Dataset parameters
    parser.add_argument("--num_cv_folds", help="Number of cross-validation folds", default=5, type=int)
    parser.add_argument("--num_cv_bins", help="Number of cross-validation bins", default=10, type=int)
    parser.add_argument(
        "--scaffold_split_val_sz", help="Scaffold spit validation slide", default=0.1, type=float
    )

    # EHIMP Paramters
    parser.add_argument("--use_erg", help="Use ERG", default=False, type=str2bool, const=True, nargs='?')
    parser.add_argument("--use_ft", help="Use Feature Tree", default=False, type=str2bool, const=True, nargs='?')
    parser.add_argument("--ft_resolution", help="Feature tree resolution", default=1, type=int)
    parser.add_argument("--rg_embedding_dim", help="Reduced graph embedding dimention", default=8, type=int)
